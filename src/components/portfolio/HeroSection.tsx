export function HeroSection() {
  return (
    <section className="grid-bg relative flex min-h-screen items-center overflow-hidden px-5 pb-16 pt-32 md:px-8">
      <div className="absolute left-[12%] top-28 h-60 w-60 rounded-full bg-lime/10 blur-[100px]" />
      <div className="mx-auto grid w-full max-w-7xl items-end gap-12 lg:grid-cols-[1fr_330px]">
        <div className="relative z-10">
          <div className="mb-8 flex items-center gap-3 font-mono text-xs uppercase tracking-[.2em] text-white/60"><span className="h-2 w-2 animate-pulse rounded-full bg-lime shadow-[0_0_16px_#c7ff48]" />Available for select projects · 2025</div>
        ...
        <aside className="float relative hidden rounded-[2rem] border border-white/10 bg-panel/80 p-5 backdrop-blur lg:block">
          <div className="aspect-[4/5] overflow-hidden rounded-[1.4rem] bg-gradient-to-br from-lime via-[#91a9ff] to-[#7a42ff] p-px">
            <div className="relative h-full rounded-[1.4rem] bg-[#11151d] p-7">
